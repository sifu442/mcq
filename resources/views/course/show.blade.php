        ...
        <div id="accordion-collapse" data-accordion="collapse">
            ...
            <h2 id="accordion-collapse-heading-{{ $loop->iteration }}">
                <button type="button"
                    ...
                    data-accordion-target="#accordion-collapse-body-{{ $loop->iteration }}" aria-expanded="{{ $loop->first ? 'true' : 'false' }}"
                    aria-controls="accordion-collapse-body-{{ $loop->iteration }}">
                    <span class="text-red-500">{{ $exam->title }}</span>
            ...
            <div id="accordion-collapse-body-{{ $loop->iteration }}" class="{{ $loop->first ? 'block' : 'hidden' }}" aria-labelledby="accordion-collapse-heading-{{ $loop->iteration }}">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                    <!-- Content for the exam goes here -->
                    <div>
                        <p class="mb-2 text-gray-500 dark:text-gray-400">{{ $exam->syllabus }}</p>
                        <!-- Add other details of the question as needed -->
                    </div>
                </div>
            </div>
            @endforeach
