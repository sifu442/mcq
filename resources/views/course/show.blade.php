        ...
        <div id="accordion-collapse" data-accordion="collapse">
            @foreach ($exams as $index => $exam)
                <h2 id="accordion-collapse-heading-{{ $exam->id }}">
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 {{ $index === 0 ? 'rounded-t-xl' : '' }} border-primary focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
